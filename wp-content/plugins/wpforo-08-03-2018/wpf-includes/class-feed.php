            ...
            <channel>
                <title>
                	<?php if(!isset($forum['title']) || !$forum['title']): ?>
                    	<?php echo esc_html($this->wpforo->general_options['title']) . ' - ' . wpforo_phrase('Recent Topics', false) ?>
                    <?php else: ?>
						<?php echo esc_html($forum['title']); ?> - <?php echo esc_html($this->wpforo->general_options['title']); ?>
                    <?php endif; ?>
                </title>
            ...
            <channel>
                <title>
					<?php if(!isset($topic['title']) || !$topic['title']): ?>
                    	<?php echo esc_html($this->wpforo->general_options['title']) . ' - ' . wpforo_phrase('Recent Posts', false); ?>
                    <?php else: ?>
