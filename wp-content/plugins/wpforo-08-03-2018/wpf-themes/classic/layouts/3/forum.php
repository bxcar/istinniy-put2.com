...
<div class="wpfl-3">
	...
	<?php foreach($forums as $key =>$forum) : 
		...
		$topics = $wpforo->topic->get_topics( array("forumid" => $forum['forumid'], "orderby" => "type, modified", "order" => "DESC", "row_count" => $wpforo->forum->options['layout_qa_intro_topics_count'] ) );
		...
		$topic_toglle = $wpforo->forum->options['layout_qa_intro_topics_toggle'];
			    ...
			    <div class="wpforo-last-topics-<?php echo intval($forum['forumid']) ?>" style="display: <?php echo ( $topic_toglle ? 'block' : 'none' ); ?>;">
			        ...
			        <div class="wpforo-last-topics-list">
			            <ul>
			                ...
			                <?php endforeach; ?>
                            <?php if( intval($forum['topics']) > $wpforo->forum->options['layout_qa_intro_topics_count'] ): ?>
                            <li>
