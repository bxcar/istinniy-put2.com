                                    ...
                                    <?php if( $wpforo->perm->forum_can( 'vf', $forum['forumid'] ) ): ?>
                                        ...
                                        <div class="wpf-head-bar">
                                            ...
                                            <?php if( $wpforo->perm->forum_can( 'ct', $cat['forumid']) ): ?>
                                                <div class="wpf-head-bar-right"><button class="wpf-button" id="add_wpftopic"><?php wpforo_phrase('Добавить тему') ?></button></div>
                                            <?php elseif( $wpforo->current_user_groupid == 4 ) : ?>
                                                <div class="wpf-head-bar-right"><button class="wpf-button not_reg_user" id="add_wpftopic"><?php wpforo_phrase('Добавить тему') ?></button></div>
                                            <?php endif; ?>
