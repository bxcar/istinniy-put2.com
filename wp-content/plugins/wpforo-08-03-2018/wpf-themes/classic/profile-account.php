...
<div class="wpforo-profile-account wpfbg-9">
    ...
    <?php if( $ID == $wpforo->current_userid || ( $wpforo->perm->usergroup_can('em') && $wpforo->perm->user_can_manage_user( $wpforo->current_userid, $ID ) ) ) :
    ...
    <?php else: ?>
    	<?php if( isset($wpforo) && isset($wpforo->current_object['user']['user_activation_key']) && $wpforo->current_object['user']['user_activation_key']): ?>
