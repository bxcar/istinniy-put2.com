...
<div class="wpforo-members-wrap">
                ...
                <div class="wpf-tr">
                    <div class="wpf-td wpfw-1">
                        <div class="wpf-field wpf-field-type-submit">
                        	<a href="<?php echo wpforo_home_url('members') ?>"><input type="button" class="wpf-member-search wpfbg-7 wpfcl-1" value="<?php wpforo_phrase('Reset Search') ?>" /></a>
							<?php if( $wpforo->member->options['search_type'] == 'filter' ): ?>
                                <a href="<?php echo wpforo_home_url('members') ?>"><input type="reset" class="wpf-member-search wpfbg-7 wpfcl-1" value="<?php wpforo_phrase('Reset Fields') ?>" /></a>
                            <?php endif; ?>
	                ...
	                <?php $bg = FALSE; foreach($members as $member) : ?>
	                  ...
	                  <tr<?php echo ( $bg ? ' style="background:#F7F7F7"' : '' ) ?>>
	                    ...
	                    <td class="wpf-members-info">
	                        ...
	                        <br />
	                        <?php $enabled_for_usergroup = ( isset($wpforo->member->options['rating_badge_ug'][$member['groupid']]) && $wpforo->member->options['rating_badge_ug'][$member['groupid']] ) ? true : false ; ?>
	...
	<?php else : ?>
		<p class="wpf-p-error"> <?php wpforo_phrase('You don\'t have permission to this page') ?> </p>
	<?php endif; ?>
</div>