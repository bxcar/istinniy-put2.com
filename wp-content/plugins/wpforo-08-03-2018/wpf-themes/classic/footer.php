                ...
                <div class="wpforo-stat-table">
                    ...
                    <div class="wpf-row wpf-last-info">
                        ...
                        <p class="wpf-stat-other">
                        	...
                        	<?php if( isset($stat['posts']) && $stat['posts'] ): ?><span class="wpf-stat-recent-posts"><i class="fa fa-list-ul"></i> <a href="<?php echo esc_url(wpforo_home_url('recent')) ?>"><?php wpforo_phrase('Недавние посты') ?></a></span><?php endif; ?>
                        </p>
                        <?php endif; ?>
                        <p class="wpf-topic-icons">
                            ...
                            <span><i class="fa fa-thumb-tack wpfcl-5"></i> <?php wpforo_phrase('Прикреплен') ?></span>
                            <span><i class="fa fa-exclamation-circle wpfcl-5"></i> <?php wpforo_phrase('Неутвержденный') ?></span>
                            <span><i class="fa fa-check-circle wpfcl-8"></i> <?php wpforo_phrase('Solved') ?></span>
                            <span><i class="fa fa-eye-slash wpfcl-1"></i> <?php wpforo_phrase('Приватный') ?></span>
...
<div id="wpf-msg-box">
	<p id="wpf-msg-box-p" class="wpf-msg-box-triangle-right top" style="font-size:0"><span><?php echo sprintf( wpforo_phrase('Please %s or %s', FALSE), '<a href="' . wpforo_login_url() . '" rel="nofollow">'.wpforo_phrase('Login', FALSE).'</a>', '<a href="' . wpforo_register_url() . '" rel="nofollow">'.wpforo_phrase('Register', FALSE).'</a>' ) ?></span></p>
</div>