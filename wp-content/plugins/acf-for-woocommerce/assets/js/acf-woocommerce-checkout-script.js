(function ($) {
    ...
    $(function () {
        ...
        //at first, always have to check validation
        var $form = $('form.checkout.woocommerce-checkout');

        acf.validation.valid = false;

        $('form.checkout.woocommerce-checkout').prependOn('submit', function (e) {
            e.preventDefault(e);
                ...
                if ($form.find('input[type="file"]').length > 0) {
                    ...
                    if ($form.data('uploading') != 'runing') {
                        ...
                        $.ajax({
                            ...
                            contentType: false,
                            processData: false,
                            url: wc_checkout_params.ajax_url + '?action=upload_ajax',
