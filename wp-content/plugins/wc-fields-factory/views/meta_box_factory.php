...
<div id="wcff_fields_factory" action="POST">
	...
	<table class="wcff_table wcff_fields_factory_header">
		<tr>
			...
			<td>
				<span id="wcff-field-type-meta-type-label"></span>
			...
			<td><a href="#" class="wcff-add-new-field button">+ <?php _e( 'Add Field', 'wc-fields-factory' ); ?></a></td>
		</tr>
	</table>
	...
	<div id="wcff-factory-tab-container">
		...
		<div class="wcff-factory-tab-child" id="wcff-factory-tab-fields-rules">			
			<table class="wcff_table">
				<tbody id="wcff-field-types-meta-body">
					<tr>
						<td class="summary">
						...
						<td style="vertical-align: top;">
							<div class="wcff-factory-field-rules-wrapper" id="wcff-factory-field-rules-wrapper">																
								<input type="button" id="wcff-add-field-rule-btn" class="wcff-add-field-rule-btn button" value="Add Field Rule">
							</div>
						</td>
					</tr>					
				</tbody>
	...
	<div id="wcff-field-factory-footer" style="display:none">
		...
		<a href="#" class="wcff-add-new-field button">+ <?php _e( 'Add Field', 'wc-fields-factory' ); ?></a>						
	</div>
