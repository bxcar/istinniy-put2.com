	...
	<div class="wrap wcff-options-wrapper">		
		...
		<form action='options.php' method='post' class='wcff-options-form'>		
			...
			<table class="wcff-option-field-row wcff_table">			
				...
				<tr>
					<td class="summary">
						<label for="post_type"><?php _e( 'Price Update', 'wc-fields-factory' ); ?></label>
						<p class="description"><?php _e( 'Updating the product price at the real time.', 'wc-fields-factory' ); ?></p>
					</td>
					<td>
						<div class="wcff-field-types-meta">			
								<div class="wcff-factory-tab-container">
									<div class="wcff-factory-tab-left-panel">
										<ul>
											...
											<li data-box="#wcff-ajax-pricing-rule-replace-container"><label><?php _e( 'Price Rules Title', 'wc-fields-factory' ); ?></label></li>
										</ul>
									</div>
									<div class="wcff-factory-tab-right-panel">
										...
										<div id="wcff-ajax-pricing-rule-replace-container" class="wcff-factory-tab-content">
											...
											<div style="<?php echo ( $wcff_ajax_pricing_rules_price_container == "default"  ) ? "display: none;" : ""; ?>" id="wcff-pricing-rules-rules-price-container">
												<label><input type="text" name="wccpf_options[ajax_price_replace_container]" placeholder="<?php _e( 'After pricing calculation replace price container class or id ( .class_one, #id_one )', 'wc-fields-factory' ); ?>" value="<?php echo $wcff_ajax_price_replace_container; ?>" /> </label>
											</div>
										</div>
