...
class WPBakeryShortCode_mvc_button extends WPBakeryShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		<div style="text-align: <?php echo $align; ?>;">
			...
			<!-- 3D button -->
			<?php if ($btn_style == '3D') { ?>
				<a href="<?php echo $btn_url; ?>" class="push_button" target="<?php echo $btn_next; ?>" style="font-size: <?php echo $btn_size; ?>; padding: <?php echo $padding_top; ?> <?php echo $padding_left; ?>; background: <?php echo $btn_bg; ?>; color: <?php echo $btn_clr; ?>; box-shadow: 0 0 0 1px <?php echo $btn_shadow; ?> inset, 0 0 0 2px rgba(255,255,255,0.15) inset, 0 4px 0 0 <?php echo $btn_shadow; ?>, 0 8px 8px 1px rgba(0,0,0,0.5);">
					<i class="<?php echo $btn_icon; ?>"></i> <?php echo $btn_text; ?>
				</a>
			<?php } ?>
		</div>
