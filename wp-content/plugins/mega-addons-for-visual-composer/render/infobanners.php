		...
		<?php if ($style_visibility == 'left' || $style_visibility == 'right') { ?>
			<div id="mega_info_bar" class="<?php echo $css_class; ?> mega-info-bar-<?php echo $some_id; ?>">		   
				...
				<div class="mega_content" style="width: <?php echo $content_width-1; ?>%; padding: <?php echo $text_padding; ?>;">
					...
					<a data-onhovercolor="<?php echo $btn_hvrclr; ?>" data-onhoverbg="<?php echo $btn_hvrbg; ?>" data-onleavebg="<?php echo $btn_bg; ?>" data-onleavecolor="<?php echo $btn_clr; ?>" href="<?php echo $btn_url; ?>" class="mega_hvr_btn <?php echo $anim_style; ?>" style="font-size: <?php echo $btn_size; ?>; color: <?php echo $btn_clr; ?>; background: <?php echo $btn_bg; ?>; border: <?php echo $border_style; ?>; border-radius: <?php echo $btn_radius; ?>; padding: <?php echo $btn_ptop/2; ?>px <?php echo $btn_pleft/2; ?>px; border-radius: <?php echo $btn_radius; ?>;">
...
vc_map( array(
	...
	'params' => array(
        ...
        array(
			...
			"param_name" 	=> 	"descsize",
			"description" 	=> 	__( 'set in pixel eg, 15px or leave blank', 'info-banner-vc' ),
			"group" 		=> 	'Content',
        ),
        array(
            "type" 			=> 	"textarea_html",
