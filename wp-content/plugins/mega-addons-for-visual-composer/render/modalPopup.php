...
class WPBakeryShortCode_modal_popup_box extends WPBakeryShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		<div class="modal-popup-box" data-bodybg="<?php echo $bodybg; ?>">
			<button class="model-popup-btn" data-id="popup-<?php echo $some_id; ?>" style="color: <?php echo $btnclr; ?>;background: <?php echo $btnbg; ?> ; border: <?php echo $border; ?>; border-radius: <?php echo $btnradius; ?>; font-size: <?php echo $btnsize; ?>; padding: <?php echo $toppadding; ?> <?php echo $leftpadding; ?>;">
				<?php echo $btntext; ?>
			</button>

			<div class="mega-model-popup <?php echo $animation; ?> animated" id="popup-<?php echo $some_id; ?>" style="position:fixed;display: none; margin-top: <?php echo $top; ?>; width: 95%;max-width: <?php echo $width; ?>; background: <?php echo $bgclr; ?>;">
