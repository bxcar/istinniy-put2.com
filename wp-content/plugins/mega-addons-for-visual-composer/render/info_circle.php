		...
		<div id="mega-info-circle" class="mega-info-circle" style="margin-top: 40px;">
        	<div class="mega-outer-section" style="border: <?php echo $outer_border; ?>;">
	        	...
	        	<div class="info-circle-icon icon-wrapper" style="background: <?php echo $icon_bg; ?>; border: <?php echo $border_clr; ?>;">
	        		<div>
	        			<?php if ($style == 'icon') { ?>
	        				<i class="<?php echo $icon; ?>" style="font-size: <?php echo $icon_size; ?>; color: <?php echo $icon_clr; ?>;"></i>
	        			<?php } ?>
	        			<?php if ($style == 'image') { ?>
    					...
    					<span class="info-circle-detail">
    						<h3 style="font-size: <?php echo $heading_size; ?>; color: <?php echo $captionclr; ?>;">
    							<?php echo $heading; ?>
    						</h3>
    						<p style="font-size: <?php echo $desc_size; ?>; color: <?php echo $captionclr; ?>;">
    							<?php echo $desc; ?>
    						</p>
    					</span>
    				</div>
    			...
    			<div class="info-circle-icon2 icon-wrapper" style="background: <?php echo $icon_bg; ?>; border: <?php echo $border_clr; ?>;">
    				<div>
    					<?php if ($style == 'icon') { ?>
	        				<i class="<?php echo $icon2; ?>" style="font-size: <?php echo $icon_size; ?>; color: <?php echo $icon_clr; ?>;"></i>
	        			<?php } ?>
	        			<?php if ($style == 'image') { ?>
    			...
    			<div class="info-circle-icon3 icon-wrapper" style="background: <?php echo $icon_bg; ?>; border: <?php echo $border_clr; ?>;">
    				<div>
    					<?php if ($style == 'icon') { ?>
	        				<i class="<?php echo $icon3; ?>" style="font-size: <?php echo $icon_size; ?>; color: <?php echo $icon_clr; ?>;"></i>
	        			<?php } ?>
	        			<?php if ($style == 'image') { ?>
    			...
    			<div class="info-circle-icon4 icon-wrapper" style="background: <?php echo $icon_bg; ?>; border: <?php echo $border_clr; ?>;">
    				<div>
    					<?php if ($style == 'icon') { ?>
	        				<i class="<?php echo $icon4; ?>" style="font-size: <?php echo $icon_size; ?>; color: <?php echo $icon_clr; ?>;"></i>
	        			<?php } ?>
	        			<?php if ($style == 'image') { ?>
    			...
    			<div class="info-circle-icon5 icon-wrapper" style="background: <?php echo $icon_bg; ?>; border: <?php echo $border_clr; ?>;">
    				<div>
    					<?php if ($style == 'icon') { ?>
	        				<i class="<?php echo $icon5; ?>" style="font-size: <?php echo $icon_size; ?>; color: <?php echo $icon_clr; ?>;"></i>
	        			<?php } ?>
	        			<?php if ($style == 'image') { ?>
        	...
        	<ul class="info-circle-mobile" style="border-left: <?php echo $outer_border; ?>;">
        		<li class="info-circle-icon">
        				<?php if ($style == 'icon') { ?>
	        				<i class="<?php echo $icon; ?>" style="font-size: <?php echo $icon_size; ?>; color: <?php echo $icon_clr; ?>; background: <?php echo $icon_bg; ?>; border: <?php echo $border_clr; ?>;"></i>
	        			<?php } ?>
	        			<?php if ($style == 'image') { ?>
        		...
        		<li class="info-circle-icon">
    					<?php if ($style == 'icon') { ?>
	        				<i class="<?php echo $icon2; ?>" style="font-size: <?php echo $icon_size; ?>; color: <?php echo $icon_clr; ?>; background: <?php echo $icon_bg; ?>; border: <?php echo $border_clr; ?>;"></i>
	        			<?php } ?>
	        			<?php if ($style == 'image') { ?>
        		...
        		<li class="info-circle-icon">
    					<?php if ($style == 'icon') { ?>
	        				<i class="<?php echo $icon3; ?>" style="font-size: <?php echo $icon_size; ?>; color: <?php echo $icon_clr; ?>; background: <?php echo $icon_bg; ?>; border: <?php echo $border_clr; ?>;"></i>
	        			<?php } ?>
	        			<?php if ($style == 'image') { ?>
        		...
        		<li class="info-circle-icon">
    					<?php if ($style == 'icon') { ?>
	        				<i class="<?php echo $icon4; ?>" style="font-size: <?php echo $icon_size; ?>; color: <?php echo $icon_clr; ?>; background: <?php echo $icon_bg; ?>; border: <?php echo $border_clr; ?>;"></i>
	        			<?php } ?>
	        			<?php if ($style == 'image') { ?>
        		...
        		<li class="info-circle-icon" style="padding-bottom: 0;">
    					<?php if ($style == 'icon') { ?>
	        				<i class="<?php echo $icon5; ?>" style="font-size: <?php echo $icon_size; ?>; color: <?php echo $icon_clr; ?>; background: <?php echo $icon_bg; ?>; border: <?php echo $border_clr; ?>;"></i>
	        			<?php } ?>
	        			<?php if ($style == 'image') { ?>
...
vc_map( array(
	...
	'params' => array(
		...
		array(
			...
			"description" 	=> 	__( 'set in pixel eg, 18px'),
			"value"			=>	"18px",
			"group" 		=> 	'General',
		),
		array(
			...
			"description" 	=> 	__( 'set in pixel eg, 15px'),
			"value"			=>	"15px",
			"group" 		=> 	'General',
		),	
		array(
		...
		array(
			...
			"description" 	=> 	__( 'set in pixel eg, 25px'),
