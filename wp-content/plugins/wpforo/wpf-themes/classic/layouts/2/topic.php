          ...
          <div class="topic-wrap <?php echo $class ?>">
              <div class="wpforo-topic">
                  ...
                  <div class="wpforo-topic-info">
                    <p class="wpforo-topic-title <?php wpforo_unread_topic($topic['topicid']); ?>"><a href="<?php echo esc_url( wpforo_topic($topic['topicid'], 'url') ) ?>"><i class="fa-1x <?php echo $classes ?>" title="<?php $icon_title = WPF()->tpl->icon('topic', $topic, false, 'title'); if( $icon_title ) echo esc_html($icon_title) ?>"></i> <?php echo esc_html($topic['title']) ?></a></p>
